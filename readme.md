...
El MSSC postula que la tasa de procesamiento consciente sigue una dinámica no lineal, tendiendo a la saturación asintótica ante niveles crecientes de estímulo[cite: 3, 6]. Este repositorio incluye:
...
* `Nadal_Ferra_MSSC_2026-2.pdf`: Documento académico que detalla la teoría, metodología y análisis de dinámica del modelo[cite: 3, 6].
